...
Begin VB.Form frmDonnées 
   ...
   Begin TabDlg.SSTab tabDonnées 
      ...
      _Version        =   393216
      TabHeight       =   520
      TabCaption(0)   =   "Description of site"
      TabPicture(0)   =   "Données.frx":030A
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "lblLocalisation"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).Control(1)=   "lblNomGiratoire"
      Tab(0).Control(1).Enabled=   0   'False
      Tab(0).Control(2)=   "fraCarBranches"
      Tab(0).Control(2).Enabled=   0   'False
      Tab(0).Control(3)=   "txtLocalisation"
      Tab(0).Control(3).Enabled=   0   'False
      Tab(0).Control(4)=   "txtNomGiratoire"
      Tab(0).Control(4).Enabled=   0   'False
      Tab(0).Control(5)=   "fraEnvironnement"
      ...
      Begin VB.Frame fraAnneau 
         Caption         =   "Circulatory carriageway"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Begin VB.Label lblRg 
            Caption         =   "External radius of roundabount :"
            Height          =   255
            Left            =   240
            TabIndex        =   31
            Top             =   1440
         ...
         End
         Begin VB.Label lblR 
            Caption         =   "Central kerbed island radius :"
            Height          =   255
            Left            =   240
            TabIndex        =   28
            Top             =   360
         ...
         Begin VB.Label lblLA 
            AutoSize        =   -1  'True
            Caption         =   "Circulatory carriageway width :"
            Height          =   195
            Left            =   240
            TabIndex        =   27
            Top             =   1080
